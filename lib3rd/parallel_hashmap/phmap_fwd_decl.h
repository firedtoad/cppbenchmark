...
template <class T> using hash_default_eq = typename priv::HashEq<T>::Eq;
...
template <typename Key, typename Compare = phmap::Less<Key>, typename Alloc = phmap::Allocator<Key>> class btree_multiset;
