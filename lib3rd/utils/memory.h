...
template <typename C, size_t N, bool reserve = false> void BM_MemoryLinear()
{
    static C c;
...
template <typename C, size_t N, bool reserve = false> void BM_MemoryMapInt()
{
    static C c;
    using value_type  = typename C::value_type;
...
template <typename C,size_t N, bool reserve = false> void BM_MemoryMapString()
{
    static C c;
    using value_type  = typename C::value_type;
    using second_type = typename value_type::second_type;
...
template <typename C,size_t N, bool reserve = false> void BM_MemorySetInt()
{
    static C c;
    using value_type = typename C::value_type;
    static rusage rusage;
...
template <typename C,size_t N, bool reserve = false> void BM_MemorySetString()
{
    static C c;
    using value_type = typename C::value_type;
    static rusage rusage;
