...
#if (defined(YYJSON_HAS_STDINT_H) && YYJSON_HAS_STDINT_H) || YYJSON_MSC_VER >= 1600 || YYJSON_STDC_VER >= 199901L || defined(_STDINT_H) ||           \
    defined(_STDINT_H_) || defined(__CLANG_STDINT_H) || defined(_STDINT_H_INCLUDED) || yyjson_has_include(<stdint.h>)
#include <stdint.h>
#elif defined(_MSC_VER)
#if _MSC_VER < 1300
...
#if (defined(YYJSON_HAS_STDBOOL_H) && YYJSON_HAS_STDBOOL_H) || (yyjson_has_include(<stdbool.h>) && !defined(__STRICT_ANSI__)) ||                     \
...
#define YYJSON_PADDING_SIZE 4
    ...
    /**
     ...
     @return A new JSON string, or NULL if an error occurs.
        ...
        When it's no longer needed, it should be freed with free() or alc->free().
     */
    yyjson_api char *yyjson_mut_write_opts(const yyjson_mut_doc *doc, yyjson_write_flag flg, const yyjson_alc *alc, size_t *len,
    ...
    /**
     ...
     @warning On 32-bit operating system, files larger than 2GB may fail to write.
     */
    yyjson_api bool yyjson_mut_write_file(const char *path, const yyjson_mut_doc *doc, yyjson_write_flag flg, const yyjson_alc *alc,
                                          yyjson_write_err *err);
    ...
    /**
     ...
     @warning On 32-bit operating system, files larger than 2GB may fail to write.
     */
    yyjson_api bool yyjson_val_write_file(const char *path, const yyjson_val *val, yyjson_write_flag flg, const yyjson_alc *alc,
                                          yyjson_write_err *err);
    ...
    /**
     ...
     @return  A new JSON string, or NULL if an error occurs.
        ...
        When it's no longer needed, it should be freed with free() or alc->free().
     */
    yyjson_api char *yyjson_mut_val_write_opts(const yyjson_mut_val *val, yyjson_write_flag flg, const yyjson_alc *alc, size_t *len,
                                               yyjson_write_err *err);
    ...
    /**
     ...
     @warning On 32-bit operating system, files larger than 2GB may fail to write.
     */
    yyjson_api bool yyjson_mut_val_write_file(const char *path, const yyjson_mut_val *val, yyjson_write_flag flg, const yyjson_alc *alc,
                                              yyjson_write_err *err);
...
#define yyjson_arr_foreach(arr, idx, max, val)                                                                                                       \
    for ((idx) = 0, (max) = yyjson_arr_size(arr), (val) = yyjson_arr_get_first(arr); (idx) < (max); (idx)++, (val) = unsafe_yyjson_get_next(val))
...
#define yyjson_obj_foreach(obj, idx, max, key, val)                                                                                                  \
    for ((idx) = 0, (max) = yyjson_obj_size(obj), (key) = (obj) ? unsafe_yyjson_get_first(obj) : NULL, (val) = (key) + 1; (idx) < (max);             \
    ...
    /** Copies and returns a new immutable document from input,
        ...
        @warning This function is recursive and may cause a stack overflow
            if the object level is too deep. */
    yyjson_api yyjson_doc *yyjson_mut_doc_imut_copy(yyjson_mut_doc *doc, yyjson_alc *alc);
    ...
    /** Copies and returns a new immutable document from input,
        ...
        @warning This function is recursive and may cause a stack overflow
            if the object level is too deep. */
    yyjson_api yyjson_doc *yyjson_mut_val_imut_copy(yyjson_mut_val *val, yyjson_alc *alc);
...
#define yyjson_mut_arr_foreach(arr, idx, max, val)                                                                                                   \
    for ((idx) = 0, (max) = yyjson_mut_arr_size(arr), (val) = yyjson_mut_arr_get_first(arr); (idx) < (max); (idx)++, (val) = (val)->next)
...
#define yyjson_mut_obj_foreach(obj, idx, max, key, val)                                                                                              \
    for ((idx) = 0, (max) = yyjson_mut_obj_size(obj), (key) = (max) ? ((yyjson_mut_val *)(obj)->uni.ptr)->next->next : NULL,                         \
    ...
    /** Replaces all matching keys with the new key.
        ...
        If `new_key` already exists, it will cause duplicate keys.
     */
    yyjson_api_inline bool yyjson_mut_obj_rename_keyn(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *key, size_t len, const char *new_key,
                                                      size_t new_len);
    ...
    yyjson_api bool unsafe_yyjson_str_pool_grow(yyjson_str_pool *pool, yyjson_alc *alc, size_t len);

    /* Ensures the capacity to at least equal to the specified value count. */
    yyjson_api bool unsafe_yyjson_val_pool_grow(yyjson_val_pool *pool, yyjson_alc *alc, size_t count);
...
#undef yyjson_mut_arr_with_func
    ...
    yyjson_api_inline bool yyjson_mut_arr_remove_range(yyjson_mut_val *arr, size_t _idx, size_t _len)
    {
        if (yyjson_likely(yyjson_mut_is_arr(arr)))
        {
    ...
    yyjson_api_inline bool yyjson_mut_arr_add_bool(yyjson_mut_doc *doc, yyjson_mut_val *arr, bool _val)
    {
        if (yyjson_likely(doc && yyjson_mut_is_arr(arr)))
        {
    ...
    yyjson_api_inline yyjson_mut_val *yyjson_mut_obj_getn(yyjson_mut_val *obj, const char *_key, size_t key_len)
    {
        uint64_t tag = (((uint64_t)key_len) << YYJSON_TAG_BIT) | YYJSON_TYPE_STR;
    ...
    yyjson_api_inline yyjson_mut_val *yyjson_mut_obj_with_kv(yyjson_mut_doc *doc, const char **pairs, size_t count)
    {
    ...
    yyjson_api_inline yyjson_mut_val *unsafe_yyjson_mut_obj_remove(yyjson_mut_val *obj, const char *key, size_t key_len, uint64_t key_tag)
    {
    ...
    yyjson_api_inline bool yyjson_mut_obj_put(yyjson_mut_val *obj, yyjson_mut_val *key, yyjson_mut_val *val)
    {
        ...
        {
            unsafe_yyjson_mut_obj_remove(obj, key->uni.str, unsafe_yyjson_get_len(key), key->tag);
            if (yyjson_likely(val))
            {
                unsafe_yyjson_mut_obj_add(obj, key, val, unsafe_yyjson_get_len(obj));
            }
...
#define yyjson_mut_obj_add_func(func)                                                                                                                \
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_null(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key)
    {
        yyjson_mut_obj_add_func({ val->tag = YYJSON_TYPE_NULL | YYJSON_SUBTYPE_NONE; });
    }

    yyjson_api_inline bool yyjson_mut_obj_add_true(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key)
    {
        yyjson_mut_obj_add_func({ val->tag = YYJSON_TYPE_BOOL | YYJSON_SUBTYPE_TRUE; });
    }

    yyjson_api_inline bool yyjson_mut_obj_add_false(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key)
    {
        yyjson_mut_obj_add_func({ val->tag = YYJSON_TYPE_BOOL | YYJSON_SUBTYPE_FALSE; });
    }

    yyjson_api_inline bool yyjson_mut_obj_add_bool(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, bool _val)
    {
        yyjson_mut_obj_add_func({ val->tag = YYJSON_TYPE_BOOL | (uint8_t)((uint8_t)(_val) << 3); });
    }

    yyjson_api_inline bool yyjson_mut_obj_add_uint(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, uint64_t _val)
    {
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_sint(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, int64_t _val)
    {
        yyjson_mut_obj_add_func({
            val->tag     = YYJSON_TYPE_NUM | YYJSON_SUBTYPE_SINT;
            val->uni.i64 = _val;
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_int(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, int64_t _val)
    {
        yyjson_mut_obj_add_func({
            val->tag     = YYJSON_TYPE_NUM | YYJSON_SUBTYPE_SINT;
            val->uni.i64 = _val;
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_real(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, double _val)
    {
        yyjson_mut_obj_add_func({
            val->tag     = YYJSON_TYPE_NUM | YYJSON_SUBTYPE_REAL;
            val->uni.f64 = _val;
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_str(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, const char *_val)
    {
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_strn(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, const char *_val, size_t _len)
    {
        if (yyjson_unlikely(!_val))
            return false;
        yyjson_mut_obj_add_func({
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_strcpy(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, const char *_val)
    {
        if (yyjson_unlikely(!_val))
            return false;
        yyjson_mut_obj_add_func({
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_strncpy(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, const char *_val, size_t _len)
    {
        if (yyjson_unlikely(!_val))
            return false;
        yyjson_mut_obj_add_func({
    ...
    yyjson_api_inline bool yyjson_mut_obj_add_val(yyjson_mut_doc *doc, yyjson_mut_val *obj, const char *_key, yyjson_mut_val *_val)
    {
        if (yyjson_unlikely(!_val))
            return false;
    ...
    yyjson_api_inline yyjson_mut_val *yyjson_mut_obj_remove_strn(yyjson_mut_val *obj, const char *_key, size_t _len)
    {
    ...
    yyjson_api yyjson_val *unsafe_yyjson_get_pointer(yyjson_val *val, const char *ptr, size_t len);

    /* `val` not null, `ptr` start with '/', `len` > 0. */
    yyjson_api yyjson_mut_val *unsafe_yyjson_mut_get_pointer(yyjson_mut_val *val, const char *ptr, size_t len);
