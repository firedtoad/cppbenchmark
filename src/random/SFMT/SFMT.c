...
#define UNUSED_VARIABLE(x) (void)(x)
    ...
    void sfmt_init_by_array(sfmt_t *sfmt, uint32_t *init_key, int key_length)
    {
        ...
        {
            r = func1(psfmt32[idxof(i)] ^ psfmt32[idxof((i + mid) % SFMT_N32)] ^ psfmt32[idxof((i + SFMT_N32 - 1) % SFMT_N32)]);
        ...
        {
            r = func2(psfmt32[idxof(i)] + psfmt32[idxof((i + mid) % SFMT_N32)] + psfmt32[idxof((i + SFMT_N32 - 1) % SFMT_N32)]);
            psfmt32[idxof((i + mid) % SFMT_N32)] ^= r;
            r -= i;
            psfmt32[idxof((i + mid + lag) % SFMT_N32)] ^= r;
            psfmt32[idxof(i)] = r;
