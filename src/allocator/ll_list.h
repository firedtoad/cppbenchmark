...
#define CONTAINER(T, S, P) ((T *)(((uintptr_t)P) - offsetof(T, S)))
...
#define scan_list(P, I) for (I = (P)->next; I != (P); I = I->next)

#define scan_list_safe(P, I, T) for (I = (P)->next, T = I->next; I != (P); I = T, T = I->next)

#define dlist_empty(T) ((T)->next == T)

#define scan_slist(P, I) for (I = (P)->next; I; I = I->next)

#define scan_slist_safe(P, I, T) for (I = (P)->next, I ? (T = I->next) : 0; I; I = T, I ? (T = I->next) : 0)
