...
BENCHMARK_TEMPLATE(BenchFind, folly::sorted_vector_map<uint32_t, Pod>)->Range(1, 1 << 10);
BENCHMARK_TEMPLATE(BenchFind, folly::heap_vector_map<uint32_t,Pod>)->Range(1, 1 << 10);
...
BENCHMARK_TEMPLATE(BenchRange, folly::heap_vector_map<uint32_t,Pod>)->Range(1, 1 << 10);
...
BENCHMARK_TEMPLATE(BenchErase, folly::heap_vector_map<uint32_t,Pod>)->Range(1, 1 << 10);
