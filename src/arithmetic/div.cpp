...
__attribute__((noinline)) double calc(double x, double y)
{
    return x / bp_double - y / bp_double;
}
__attribute__((noinline)) double calc1(double x, double y)
{
...
__attribute__((noinline)) int calc1_32(int x, int y)
{
    return (x - y) / bp_int32;
}
...
__attribute__((noinline)) int64_t calc1_64(int64_t x, int64_t y)
{
    return (x - y) / bp_int64;
}
