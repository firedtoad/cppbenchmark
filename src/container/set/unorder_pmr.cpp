...
BENCHMARK_TEMPLATE(BM_reserve, std::unordered_set<int>)->Range(1 << 10, 1 << 20);
BENCHMARK_TEMPLATE(BM_PMR_reserve, std::pmr::unordered_set<int>)->Range(1 << 10, 1 << 20);
...
BENCHMARK_TEMPLATE(BM_Range, std::unordered_set<int>)->Range(1 << 10, 1 << 20);
BENCHMARK_TEMPLATE(BM_PMR_Range, std::pmr::unordered_set<int>)->Range(1 << 10, 1 << 20);
...
BENCHMARK_TEMPLATE(BM_Find, std::unordered_set<int>)->Range(1 << 10, 1 << 20);
BENCHMARK_TEMPLATE(BM_PMR_Find, std::pmr::unordered_set<int>)->Range(1 << 10, 1 << 20);
