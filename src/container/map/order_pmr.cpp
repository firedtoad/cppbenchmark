...
{
    std::vector<uint8_t> vec(state.range(0)*48);
...
BENCHMARK_TEMPLATE(BM_Insert, std::map<int, int>)->Range(1 << 10, 1 << 20);
BENCHMARK_TEMPLATE(BM_PMR_Insert, std::pmr::map<int, int>)->Range(1 << 10, 1 << 20);
...
BENCHMARK_TEMPLATE(BM_Range, std::map<int, int>)->Range(1 << 10, 1 << 20);
BENCHMARK_TEMPLATE(BM_PMR_Range, std::pmr::map<int, int>)->Range(1 << 10, 1 << 20);
...
BENCHMARK_TEMPLATE(BM_Find, std::map<int, int>)->Range(1 << 10, 1 << 20);
BENCHMARK_TEMPLATE(BM_PMR_Find, std::pmr::map<int, int>)->Range(1 << 10, 1 << 20);
