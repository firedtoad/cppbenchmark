...
BENCHMARK_TEMPLATE(BenchInsert, eastl::vector_set<td::pair<uint32_t, uint32_t>>)->Range(1, 1 << 10);
...
BENCHMARK_TEMPLATE(BenchFind, eastl::vector_set<uint32_t, Pod>)->Range(1, 1 << 10);
...
BENCHMARK_TEMPLATE(BenchRangeSet, eastl::vector_set<std::pair<uint32_t, Pod>>)->Range(1, 1 << 10);
...
BENCHMARK_TEMPLATE(BenchEraseMulti, eastl::vector_set<std::pair<uint32_t, Pod>>)->Range(1, 1 << 10);
